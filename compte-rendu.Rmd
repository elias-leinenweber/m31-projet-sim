...
<!-- Donner l'algorithme sous forme de pseudocode -- utiliser packages : -->
...
On remarque que l'efficacité du système atteint son pic en $n \approx 35$.
...
[`https://git.unistra.fr/leinenweber/m31-projet-sim`](https://git.unistra.fr/leinenweber/m31-projet-sim).
